...
var stripe = Stripe('pk_test_51H2Oj1HBcksNL9JCK5wchGqIgUjeZrNB570maFZXK9aqaOFA6nwQtJESKMXYQ2AyjXPUBkVgSoqerD0O52dC5VzH00Q5aXDJeu');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); // Prevents form from reloading any other page
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.bookTour)(tourId); // e.target.textContent = '';
  });
}
